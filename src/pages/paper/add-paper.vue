    ...
    <div class="frame-page">
        <div class="h-panel">
            ...
            <div class="h-panel-body">
                <Form :label-width="110" :model="data" :rules="validationRules" mode="single" ref="form">
                    ...
                    <FormItem label="试卷" prop="paperTypeId">
                    ...
                    <FormItem label="考试时间" prop="time" v-width="300">
                        <NumberInput v-model="data.time" :useOperate="true"></NumberInput>
                    </FormItem>
                    <FormItem>
                            ...
                            <Modal v-model="questionAdding" :closeOnMask="false">
                                ...
                                <div>
                                    <div class="h-panel">
                                        ...
                                        <div class="h-panel-body">
                                            <Table ref="questionLibTable" :datas="questionLib" stripe selectRow checkbox
                                                   @trdblclick="trclick">
...
<script>
    export default {
        ...
        methods: {
            ...
            wangToAddQuestion() {
                let validSubjectId = this.$refs.form.validField('subjectId');
                let validQuestionType = this.$refs.form.validField('questionType');
                if (validSubjectId.valid&&validQuestionType.valid) {
